...
type Tab = "users" | "analytics" | "emails" | "config";
    ...
    <div className="space-y-5">
      <header className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="muted text-sm">Run BuilderQuest like a product. All settings stored locally; in production this UI talks to your backend.</p>
        </div>
      </header>
