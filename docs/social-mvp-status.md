...
- Test count: 90 → **674** (560 SPA + 114 social-svc) as of #103.
- Bundle delta: ~+50 KB JS gzipped (mostly the AdminPublicProfile tab + social SSR helpers; the SSR HTML itself is server-rendered and never reaches the SPA bundle).
